...
// saves.
export const PLATE_RULE = 'Every recipe or meal you propose, describe, or build — breakfast, lunch, dinner, or snack — must follow this plate composition, roughly by volume: 40-50% vegetables, 25% cereals/grains, 25% protein, 10% fat/oil. This is mandatory for every single recipe, no exceptions and no meal type left out — choose ingredients and portions so the plate actually reflects that split, not just a plausible-sounding meal.'
