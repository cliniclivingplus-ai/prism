...
export function renderMarkdownBold(text: string): React.ReactNode {
  ...
  return parts.map((part, i) => {
    ...
    if (image) {
      ...
      return <img key={i} src={image[2]} alt={image[1]} loading="lazy" decoding="async" style={{ maxWidth: '100%', maxHeight: 220, width: 'auto', height: 'auto', objectFit: 'cover', display: 'block', borderRadius: 10, margin: '10px 0' }} />
    }
