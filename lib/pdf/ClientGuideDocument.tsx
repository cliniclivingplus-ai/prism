...
export type GuideData = {
  ...
  reachInfo: { phone: string; hours: string; frontDesk: string } // "When to reach us" contact details — coach-entered per roadmap, all blank by default rather than a fabricated clinic phone/hours
